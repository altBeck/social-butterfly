...
const BlogPage = (props: DemoPageProps) => {
  const { data } = useTina({
    query: props.query,
...
export const getStaticProps = async ({
  ...
  params: StaticParams
}): Promise<{ props: DemoPageProps }> => {
  let data: DemoPostData = {}
  let query = ''
...
const ContentSection = ({ content }: { content: (DemoBlock | null)[] }) => {
  return (
    <div className='relative py-16 bg-white overflow-hidden text-black'>
      ...
      <div className='relative px-4 sm:px-6 lg:px-8'>
        <div className='text-left text-lg max-w-prose mx-auto space-y-6'>
